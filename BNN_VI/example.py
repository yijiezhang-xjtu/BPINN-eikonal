...
"""
    Toys.example of NNs based on Varationl Inference
"""
...
class MLP_BBB(nn.Module):
    ...
    def sample_elbo(self, input, target, samples):
        ...
        for i in range(samples):
            ...
            # print('log_priors[i]', i, log_priors[i])
            # print('log_priors[i]', i, log_posts[i])
            # print('log_likes', i, log_likes[i])
...
for epoch in range(epochs):  # loop over the dataset multiple times
    ...
    # if epoch % 100 == 0:
    #     torch.save(net.state_dict(),"test"+str(epoch)+".pt")
